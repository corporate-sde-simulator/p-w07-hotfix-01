...
> **Welcome to Product-Track Week 7, Hotfix 1!**
...
1. **Read the comments** at the top of `metricsCollector.py` - they describe the problem
...
| File | Purpose |
|------|---------|
| `metricsCollector.py` | The code with bugs - **fix this file** |
...
### Bug #1
**User Report / Alert:**
> "user_id in labels â†’ cardinality explosion"
...
### Bug #2
**User Report / Alert:**
> "Remove this â€” high cardinality"
...
### Bug #3
**User Report / Alert:**
> "Histogram buckets inappropriate for HTTP requests"
...
1. **Read the top comment block** in `metricsCollector.py` carefully - it has:
